...
Latest release: [Limit Bar 1.1.0 DMG](https://github.com/artemsvit/Limit-Bar/releases/download/v1.1.0/Limit-Bar-1.1.0.dmg)
...
```sh
scripts/build-signed-dmg.sh 1.1.0 9
scripts/publish-release.sh 1.1.0 9
```
