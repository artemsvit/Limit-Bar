...
Latest release: [Limit Bar 1.1.5 DMG](https://github.com/artemsvit/Limit-Bar/releases/download/v1.1.5/Limit-Bar-1.1.5.dmg)
...
```sh
scripts/build-signed-dmg.sh 1.1.5 14
scripts/publish-release.sh 1.1.5 14
```
