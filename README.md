...
Latest release: [Limit Bar 1.1.4 DMG](https://github.com/artemsvit/Limit-Bar/releases/download/v1.1.4/Limit-Bar-1.1.4.dmg)
...
```sh
scripts/build-signed-dmg.sh 1.1.4 13
scripts/publish-release.sh 1.1.4 13
```
