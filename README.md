...
Latest release: [Limit Bar 1.1.6 DMG](https://github.com/artemsvit/Limit-Bar/releases/download/v1.1.6/Limit-Bar-1.1.6.dmg)
...
```sh
scripts/build-signed-dmg.sh 1.1.6 15
scripts/publish-release.sh 1.1.6 15
```
