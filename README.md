...
Latest release: [Limit Bar 1.0.7 DMG](https://github.com/artemsvit/Limit-Bar/releases/download/v1.0.7/Limit-Bar-1.0.7.dmg)
...
```sh
scripts/build-signed-dmg.sh 1.0.7 8
scripts/publish-release.sh 1.0.7 8
```
