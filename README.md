...
Latest release: [Limit Bar 1.1.7 DMG](https://github.com/artemsvit/Limit-Bar/releases/download/v1.1.7/Limit-Bar-1.1.7.dmg)
...
```sh
scripts/build-signed-dmg.sh 1.1.7 16
scripts/publish-release.sh 1.1.7 16
```
