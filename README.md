...
Latest release: [Limit Bar 1.1.1 DMG](https://github.com/artemsvit/Limit-Bar/releases/download/v1.1.1/Limit-Bar-1.1.1.dmg)
...
```sh
scripts/build-signed-dmg.sh 1.1.1 10
scripts/publish-release.sh 1.1.1 10
```
